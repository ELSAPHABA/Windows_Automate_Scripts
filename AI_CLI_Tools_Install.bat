...
:: 2. Antigravity CLI Install
echo [2/5] Installing Antigravity CLI...
call irm https://antigravity.google/cli/install.ps1 | iex

:: 3. OpenAI Codex Install
echo [3/5] Installing @openai/codex...
call npm install -g @openai/codex

:: 4. GitHub Copilot CLI Install
echo [4/5] Installing @github/copilot...
